...
class _DetailsScreenState extends State<DetailsScreen> {
    ...
    return BlocProvider<ImageBloc>(
      ...
      child: BlocListener<ImageBloc, ImageState>(
        listener: (context, state) {
          state.maybeMap(
              imageUploaded: (state) {
                context.read<RecipesBloc>().add(RecipesEvent.addRecipe(
                    state.recipe.copyWith(photoUri: state.uri)));
              },
              orElse: () {});
        },
          ...
          builder: (context, state) {
            return state.maybeMap(
                recipesLoaded: (state) {
                  ...
                  context
                      .read<ImageBloc>()
                      .add(LoadFromUri(recipe.photoUri, recipe));
                  return Scaffold(
                    appBar: AppBar(
  ...
  Future<void> uploadFile(
    ...
    context.read<ImageBloc>().add(UploadImage(File(image.path), recipe));
  }
